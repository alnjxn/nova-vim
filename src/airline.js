...
" Insert mode
let s:I1 = [ "${uiGroups.gray1}" , "${colorValues.colors.yellow}", "" , ""  ]
let s:I2 = s:N2
let s:I3 = s:N3
...
" Visual mode
let s:V1 = [ "${uiGroups.gray6}" , "${colorValues.colors.pink}" , "" , "" ]
let s:V2 = s:N2
let s:V3 = s:N3
...
" Replace mode
let s:R1 = [ "${uiGroups.gray6}" , "${colorValues.colors.purple}" , "" , "" ]
let s:R2 = s:N2
let s:R3 = s:N3
...
" Inactive mode
let s:IN1 = [ "${uiGroups.background}" , "${uiGroups.gray2}" , "" , "" ]
let s:IN2 = s:IN1
let s:IN3 = s:IN1
...
let s:AirlineError = [ "${uiGroups.gray6}" , "${uiGroups.userActionNeeded}" , "" , "" ]
...
let s:AirlineWarning = [ "${uiGroups.gray6}" , "${colorValues.colors.orange}" , "" , "" ]
...
let g:airline#themes#nova#palette.tabline = {
  \\ 'airline_tab': s:N2,
  \\ 'airline_tabsel': s:N1,
  \\ 'airline_tabtype': [ "${uiGroups.background}" , "${colorValues.colors.green}" , "" , "" ],
